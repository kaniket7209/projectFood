...
def document_verification():
    if request.method == 'POST':
        print(1)
        saveImageDirPath = os.path.join(
            os.getcwd(), 'static/Document_verification')
...
def profile():
    ...
    listOfItems = [
        {
            'name': 'Veg Biryani',
            'Tagline': 'A plate full of love and health.',
            'logo':"https://www.logodesign.net/logo/smoking-burger-with-lettuce-3624ld.png?size=2&industry=food"
        },
        {
    ...
    return render_template('profile_page.html', storeName=storeName, tagline=tagline, followers=followers, followings=followings,listOfItems= listOfItems)
